...
[_QWERTY] = {
  ...
  { KC_F12 ,  MOUSE ,   FUN ,     LOWER , KC_LSFT , KC_LGUI , KC_SPC , RAISE , KC_LCTL , KC_LALT, KC_BSPC , KC_ENT }
 } ,
...
[_RAISE ] = {
  ...
  { _______ , KC_LBRC , KC_RBRC , KC_LPRN , KC_RPRN , KC_BSPC , _______ , KC_ENT ,  KC_SPC ,  KC_LCBR , KC_RCBR , _______ } ,

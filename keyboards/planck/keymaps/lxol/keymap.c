...
[_LOWER2] = LAYOUT_planck_grid (
   XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , KC_END  , XXXXXXX , KC_HOME , XXXXXXX ,  XXXXXXX , KC_LPRN ,  KC_RPRN , KC_BSPC  ,
   XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , KC_LEFT , KC_DOWN ,  KC_UP ,   KC_RIGHT , KC_LBRC , KC_RBRC  ,
   XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , KC_PGDOWN, KC_PGUP , KC_LCBR ,  KC_RCBR , KC_END  ,

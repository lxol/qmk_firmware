...
[_QWERTY] = {
  ...
  { KC_F12 ,  MOUSE ,   FUN ,     LOWER ,   KC_LSFT , KC_LGUI , KC_SPC , RAISE , KC_LCTL , _______ , KC_BSPC , KC_ENT }
 } ,          
...
[_LOWER] = { 
  ...
  { KC_CAPS , BL_DEC ,  BL_INC ,  _______ , _______ , _______ , _______ , _______ , _______ , KC_VOLD ,  KC_VOLU , KC_MPLY }
 } ,                               

[_RAISE ] = { 
  { KC_GRV ,  KC_1 ,    KC_2 ,    KC_3 ,    KC_4 ,    KC_5 ,    KC_6 ,    KC_7 ,    KC_8 ,    KC_9 ,     KC_0 ,    _______ } , 
  { _______ , KC_LBRC , KC_RBRC , KC_LPRN , KC_RPRN , KC_BSPC , _______ , KC_ENT ,  _______ , _______ ,  _______ , _______ } , 
  { _______ , KC_PIPE , KC_BSLS , KC_LCBR , KC_RCBR , KC_ENT ,  KC_LEFT , KC_DOWN , KC_UP ,   KC_RIGHT , _______ , _______ } , 
...
[_FUN] = { 
  ...
  { _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ } , 
  { _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ } , 
  { KC_F8 ,  KC_F9 ,  _______ , _______ , _______ , _______ , _______ , _______ , _______ , KC_VOLD , KC_VOLU , KC_MPLY }
 } ,          

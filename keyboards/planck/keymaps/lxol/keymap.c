...
[_QWERTY] = {
  ...
  { KC_F24 ,  MOUSE ,   FUN ,     LOWER ,   KC_LSFT , KC_LGUI , KC_SPC , RAISE , KC_LCTL , _______ , KC_BSPC , KC_ENT }
 } ,          

[_LOWER] = { 
  { _______ , _______ , _______ , _______ , _______ , _______ , _______ , KC_PGDN , KC_PGUP , KC_LPRN ,  KC_RPRN , _______ } , 

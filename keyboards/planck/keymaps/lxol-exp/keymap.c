...
const uint16_t PROGMEM fn_actions[] = {
  ...
  [2] = ACTION_LAYER_TAP_KEY(_LOWER, KC_BSPC),
  [3] = ACTION_MODS_TAP_KEY(MOD_LALT, KC_ENT)
};

#define CTL_ENT KC_FN0
#define SFT_ENT KC_FN1
#define LOWER_BSPC KC_FN2
#define LALT_ENT KC_FN3 
...
[_QWERTY] = {
  ...
  { KC_F24 ,  MOUSE, KC_BSPC  , LOWER , KC_LSFT , KC_LGUI , KC_SPC , RAISE , KC_LCTL , KC_ENT , KC_BSPC , KC_ENT }
 } , 
...
[_LOWER] = { 
  ...
  { _______ , _______ , _______ , _______ , _______ , _______ , KC_BSPC , _______ , _______ , KC_VOLD ,  KC_VOLU , KC_MPLY }
 } ,          

[_RAISE ] = { 
  { KC_GRV ,  KC_1 ,    KC_2 ,    KC_3 ,    KC_4 ,    KC_5 ,     KC_6 ,    KC_7 ,    KC_8 ,    KC_9 ,    KC_0 ,    _______ } , 
  { _______ , KC_LBRC , KC_RBRC , KC_LPRN ,KC_RPRN , KC_BSPC ,  _______ , KC_ENT , KC_RPRN , KC_LCBR , KC_RCBR , _______ } , 

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT( /* Qwerty */
    ...
    KC_ESC, LD_LOWER1, LD_LOWER,  KC_LSFT, KC_LALT,  KC_ESC,  KC_ENT, KC_SPC,  LD_RAISE, KC_LCTL, KC_RGUI, KC_ENT
  ),
  ...
  [_RAISE] = LAYOUT( /* [> RAISE <] */
    ...
    KC_TAB, KC_ESC, KC_LBRC, KC_RBRC, KC_BSPC,                    KC_ESC, KC_ENT,    XXXXXXX,   KC_QUOT, XXXXXXX,
  ...
  [_LOWER] = LAYOUT( /* [> RAISE <] */
    KC_EXLM, KC_AT,   KC_HASH,   KC_DLR, KC_PERC,                  XXXXXXX,  KC_LCBR,    KC_RCBR,   KC_LPRN, KC_RPRN,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX,  XXXXXXX,    XXXXXXX,   XXXXXXX, KC_QUOT,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX,  KC_LBRC,    KC_RBRC,   XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX  ),

  [_LOWER1] = LAYOUT( /* [> RAISE <] */
    XXXXXXX, XXXXXXX,   XXXXXXX,   XXXXXXX, XXXXXXX,                XXXXXXX, XXXXXXX,   XXXXXXX ,   XXXXXXX, KC_MINS,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                    KC_LEFT, KC_DOWN,    KC_UP,   KC_RIGHT, KC_DOUBLE_QUOTE,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX,  XXXXXXX,    XXXXXXX,   XXXXXXX, KC_PLUS,
    XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX  ),
